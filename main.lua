loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "Blox Fruit By Hoang Thanh",
         Animation = "Youtube:   LhtDZBozz Roblox"
         },
        Key = {
        KeySystem = true,
        Title = "ThanhDepzai Hub [Tong Hop]",
        Description = "Blox Fruit TongHop",
        KeyLink = "https://link4m.com/jkRUw",
        Keys = {"FREE_thanhdepzai67sybau6767"},
        Notifi = {
        Notifications = true,
        CorrectKey = "Wrong Key Successfull ✅",
       Incorrectkey = "Working Key No Key ❌",
       CopyKeyLink = "https://link4m.com/jkRUw"
      }
    }
  })

       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=138212423171539",
       Size = {60, 60},
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/tlredzhub/Scripts/refs/heads/main/main.lua"))(Settings)
  end
  })
  AddButton(Tab2o, {
     Name = "Min Gaming",
